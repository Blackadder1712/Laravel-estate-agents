  ...
  <form @submit.prevent="create">
    <div class="grid grid-cols-6 gap-4">
      <div class="col-span-2">
        <label class="label">Beds</label> <!--form label-->
        <input v-model.number="form.beds" type="text" class="input"/><!--input style-->
      ...
      <div class="col-span-6">
        <button type="submit" class="bg-indigo-600 hover:bg-indigo-500 text-white font-medium p-2 rounded-md dark:bg-indigo-500 hover:bg-indigo-400">Create</button>
      </div>
    </div>
  </form>
</template>
